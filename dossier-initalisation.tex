...
La société SPIE souhaite améliorér son activité de maintenance en vue d'une intégratin a base de l'ERP SAP. Le but principal est l'amélioration du processus de maintenance. Les types de maintenance auxquels SPIE fait référence son variés: cela va de la maintenance informatique des techniciens sur site jusqu'a la maintenance des infrastructures. \\
