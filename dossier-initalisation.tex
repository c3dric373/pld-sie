...
L’objet principal pour le périmètre à traiter est l’objet métier « CONTRAT » qui permet de
traiter et gérer les facettes suivantes :
- La partie forfaitaire « préventif et curatif » standard.
- La partie « bon de commande ».
o Curatif exceptionnel (exemple vandalisme).
o Petits travaux induits (amélioration des installations ou traitement de
l’obsolescence). 
